package com.tessell.event.client.invoker;
...
import com.tessell.event.client.invoker.auth.Authentication;
...
@Component("com.tessell.event.client.invoker.ApiClient")
