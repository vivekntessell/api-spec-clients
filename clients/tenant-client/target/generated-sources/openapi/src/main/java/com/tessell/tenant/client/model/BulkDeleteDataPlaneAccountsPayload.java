 ...
 */
@JsonPropertyOrder({
  BulkDeleteDataPlaneAccountsPayload.JSON_PROPERTY_TENANT_ID,
  BulkDeleteDataPlaneAccountsPayload.JSON_PROPERTY_SUBSCRIPTION_ID,
  BulkDeleteDataPlaneAccountsPayload.JSON_PROPERTY_SKIP_DELETION,
  BulkDeleteDataPlaneAccountsPayload.JSON_PROPERTY_SCHEDULE_DELETION_AFTER_DAYS
})
@JsonTypeName("BulkDeleteDataPlaneAccountsPayload")
...
public class BulkDeleteDataPlaneAccountsPayload {
  ...
  public BulkDeleteDataPlaneAccountsPayload tenantId(UUID tenantId) {
  ...
  **/
  ...
  public BulkDeleteDataPlaneAccountsPayload subscriptionId(UUID subscriptionId) {
  ...
  **/
  ...
  public BulkDeleteDataPlaneAccountsPayload skipDeletion(List<SkipDeletionInfo> skipDeletion) {
    
    this.skipDeletion = skipDeletion;
    return this;
  }

  public BulkDeleteDataPlaneAccountsPayload addSkipDeletionItem(SkipDeletionInfo skipDeletionItem) {
  ...
  **/
  ...
  public BulkDeleteDataPlaneAccountsPayload scheduleDeletionAfterDays(Integer scheduleDeletionAfterDays) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BulkDeleteDataPlaneAccountsPayload bulkDeleteDataPlaneAccountsPayload = (BulkDeleteDataPlaneAccountsPayload) o;
    return Objects.equals(this.tenantId, bulkDeleteDataPlaneAccountsPayload.tenantId) &&
        Objects.equals(this.subscriptionId, bulkDeleteDataPlaneAccountsPayload.subscriptionId) &&
        Objects.equals(this.skipDeletion, bulkDeleteDataPlaneAccountsPayload.skipDeletion) &&
        Objects.equals(this.scheduleDeletionAfterDays, bulkDeleteDataPlaneAccountsPayload.scheduleDeletionAfterDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkDeleteDataPlaneAccountsPayload {\n");
