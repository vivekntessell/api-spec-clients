 ...
 */
@JsonPropertyOrder({
  BulkDeleteSubscriptionsPayload.JSON_PROPERTY_TENANT_ID,
  BulkDeleteSubscriptionsPayload.JSON_PROPERTY_SUBSCRIPTION_ID,
  BulkDeleteSubscriptionsPayload.JSON_PROPERTY_SKIP_DELETION,
  BulkDeleteSubscriptionsPayload.JSON_PROPERTY_SCHEDULE_DELETION_AFTER_DAYS
})
@JsonTypeName("BulkDeleteSubscriptionsPayload")
...
public class BulkDeleteSubscriptionsPayload {
  ...
  public BulkDeleteSubscriptionsPayload tenantId(UUID tenantId) {
  ...
  **/
  ...
  public BulkDeleteSubscriptionsPayload subscriptionId(UUID subscriptionId) {
  ...
  **/
  ...
  public BulkDeleteSubscriptionsPayload skipDeletion(List<SkipDeletionInfo> skipDeletion) {
    
    this.skipDeletion = skipDeletion;
    return this;
  }

  public BulkDeleteSubscriptionsPayload addSkipDeletionItem(SkipDeletionInfo skipDeletionItem) {
  ...
  **/
  ...
  public BulkDeleteSubscriptionsPayload scheduleDeletionAfterDays(Integer scheduleDeletionAfterDays) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BulkDeleteSubscriptionsPayload bulkDeleteSubscriptionsPayload = (BulkDeleteSubscriptionsPayload) o;
    return Objects.equals(this.tenantId, bulkDeleteSubscriptionsPayload.tenantId) &&
        Objects.equals(this.subscriptionId, bulkDeleteSubscriptionsPayload.subscriptionId) &&
        Objects.equals(this.skipDeletion, bulkDeleteSubscriptionsPayload.skipDeletion) &&
        Objects.equals(this.scheduleDeletionAfterDays, bulkDeleteSubscriptionsPayload.scheduleDeletionAfterDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkDeleteSubscriptionsPayload {\n");
