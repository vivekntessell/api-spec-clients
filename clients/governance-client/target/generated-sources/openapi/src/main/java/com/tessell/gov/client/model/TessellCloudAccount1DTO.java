 ...
 */
@JsonPropertyOrder({
  TessellCloudAccount1DTO.JSON_PROPERTY_SECRET,
  TessellCloudAccount1DTO.JSON_PROPERTY_SECRET_A_R_N,
  TessellCloudAccount1DTO.JSON_PROPERTY_ACCOUNT_ID,
  TessellCloudAccount1DTO.JSON_PROPERTY_CLOUD_ACCOUNT_TYPE,
  TessellCloudAccount1DTO.JSON_PROPERTY_CLOUD_LOCATION_ID,
  TessellCloudAccount1DTO.JSON_PROPERTY_DESCRIPTION,
  TessellCloudAccount1DTO.JSON_PROPERTY_NAME,
  TessellCloudAccount1DTO.JSON_PROPERTY_MANAGED_TYPE,
  TessellCloudAccount1DTO.JSON_PROPERTY_STATUS
})
...
public class TessellCloudAccount1DTO {
  ...
  public TessellCloudAccount1DTO secret(Map<String, TessellParameterDTO> secret) {
    
    this.secret = secret;
    return this;
  }

  public TessellCloudAccount1DTO putSecretItem(String key, TessellParameterDTO secretItem) {
    if (this.secret == null) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO secretARN(String secretARN) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO accountId(String accountId) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO cloudAccountType(TessellCloudAccountTypeDTO cloudAccountType) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO cloudLocationId(String cloudLocationId) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO description(String description) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO name(String name) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO managedType(TessellManagedTypeDTO managedType) {
  ...
  **/
  ...
  public TessellCloudAccount1DTO status(TessellCloudAccountStatusDTO status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellCloudAccount1DTO cloudAccount1 = (TessellCloudAccount1DTO) o;
  ...
  public String toString() {
    ...
    sb.append("class TessellCloudAccount1DTO {\n");
