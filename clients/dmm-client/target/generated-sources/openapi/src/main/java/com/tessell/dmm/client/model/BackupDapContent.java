 ...
 */
@JsonPropertyOrder({
  BackupDapContent.JSON_PROPERTY_AUTOMATED,
  BackupDapContent.JSON_PROPERTY_MANUAL
})
@JsonTypeName("BackupDapContent")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class BackupDapContent {
  ...
  public BackupDapContent automated(Boolean automated) {
  ...
  **/
  ...
  public BackupDapContent manual(List<DapManualInfo> manual) {
    
    this.manual = manual;
    return this;
  }

  public BackupDapContent addManualItem(DapManualInfo manualItem) {
    if (this.manual == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BackupDapContent backupDapContent = (BackupDapContent) o;
    return Objects.equals(this.automated, backupDapContent.automated) &&
        Objects.equals(this.manual, backupDapContent.manual);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackupDapContent {\n");
