 ...
 */
@JsonPropertyOrder({
  TessellSanitizationScheduleUpdatePayloadScriptVersionInfo.JSON_PROPERTY_USE_ACTIVE_SCRIPT_VERSION,
  TessellSanitizationScheduleUpdatePayloadScriptVersionInfo.JSON_PROPERTY_SCRIPT_VERSION
})
@JsonTypeName("TessellSanitizationScheduleUpdatePayload_scriptVersionInfo")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class TessellSanitizationScheduleUpdatePayloadScriptVersionInfo {
  ...
  public TessellSanitizationScheduleUpdatePayloadScriptVersionInfo useActiveScriptVersion(Boolean useActiveScriptVersion) {
  ...
  **/
  ...
  public TessellSanitizationScheduleUpdatePayloadScriptVersionInfo scriptVersion(String scriptVersion) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellSanitizationScheduleUpdatePayloadScriptVersionInfo tessellSanitizationScheduleUpdatePayloadScriptVersionInfo = (TessellSanitizationScheduleUpdatePayloadScriptVersionInfo) o;
    return Objects.equals(this.useActiveScriptVersion, tessellSanitizationScheduleUpdatePayloadScriptVersionInfo.useActiveScriptVersion) &&
        Objects.equals(this.scriptVersion, tessellSanitizationScheduleUpdatePayloadScriptVersionInfo.scriptVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class TessellSanitizationScheduleUpdatePayloadScriptVersionInfo {\n");
