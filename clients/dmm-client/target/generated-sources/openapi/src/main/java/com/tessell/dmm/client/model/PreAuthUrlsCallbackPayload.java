...
@JsonPropertyOrder({
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_PREV_WORKFLOW_NAME,
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_NEW_WORKFLOW_NAME,
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_STATUS,
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_PAYLOAD,
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_CONTEXT,
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_LAST_RUN_COUNT,
  PreAuthUrlsCallbackPayload.JSON_PROPERTY_MAX_RUN_COUNT
})
@JsonTypeName("PreAuthUrlsCallbackPayload")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class PreAuthUrlsCallbackPayload {
  ...
  public PreAuthUrlsCallbackPayload prevWorkflowName(String prevWorkflowName) {
  ...
  **/
  ...
  public PreAuthUrlsCallbackPayload newWorkflowName(String newWorkflowName) {
  ...
  **/
  ...
  public PreAuthUrlsCallbackPayload status(ArgoWorkflowStatus status) {
  ...
  **/
  ...
  public PreAuthUrlsCallbackPayload payload(Map<String, Object> payload) {
    
    this.payload = payload;
    return this;
  }

  public PreAuthUrlsCallbackPayload putPayloadItem(String key, Object payloadItem) {
  ...
  **/
  ...
  public PreAuthUrlsCallbackPayload context(Object context) {
  ...
  **/
  ...
  public PreAuthUrlsCallbackPayload lastRunCount(Integer lastRunCount) {
  ...
  **/
  ...
  public PreAuthUrlsCallbackPayload maxRunCount(Integer maxRunCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PreAuthUrlsCallbackPayload preAuthUrlsCallbackPayload = (PreAuthUrlsCallbackPayload) o;
    return Objects.equals(this.prevWorkflowName, preAuthUrlsCallbackPayload.prevWorkflowName) &&
        Objects.equals(this.newWorkflowName, preAuthUrlsCallbackPayload.newWorkflowName) &&
        Objects.equals(this.status, preAuthUrlsCallbackPayload.status) &&
        Objects.equals(this.payload, preAuthUrlsCallbackPayload.payload) &&
        Objects.equals(this.context, preAuthUrlsCallbackPayload.context) &&
        Objects.equals(this.lastRunCount, preAuthUrlsCallbackPayload.lastRunCount) &&
        Objects.equals(this.maxRunCount, preAuthUrlsCallbackPayload.maxRunCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class PreAuthUrlsCallbackPayload {\n");
