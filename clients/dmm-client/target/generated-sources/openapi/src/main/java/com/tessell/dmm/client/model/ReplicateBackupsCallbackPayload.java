...
@JsonPropertyOrder({
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_PREV_WORKFLOW_NAME,
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_NEW_WORKFLOW_NAME,
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_STATUS,
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_PAYLOAD,
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_CONTEXT,
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_LAST_RUN_COUNT,
  ReplicateBackupsCallbackPayload.JSON_PROPERTY_MAX_RUN_COUNT
})
@JsonTypeName("ReplicateBackupsCallbackPayload")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class ReplicateBackupsCallbackPayload {
  ...
  public ReplicateBackupsCallbackPayload prevWorkflowName(String prevWorkflowName) {
  ...
  **/
  ...
  public ReplicateBackupsCallbackPayload newWorkflowName(String newWorkflowName) {
  ...
  **/
  ...
  public ReplicateBackupsCallbackPayload status(ArgoWorkflowStatus status) {
  ...
  **/
  ...
  public ReplicateBackupsCallbackPayload payload(Map<String, Object> payload) {
    
    this.payload = payload;
    return this;
  }

  public ReplicateBackupsCallbackPayload putPayloadItem(String key, Object payloadItem) {
  ...
  **/
  ...
  public ReplicateBackupsCallbackPayload context(Object context) {
  ...
  **/
  ...
  public ReplicateBackupsCallbackPayload lastRunCount(Integer lastRunCount) {
  ...
  **/
  ...
  public ReplicateBackupsCallbackPayload maxRunCount(Integer maxRunCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReplicateBackupsCallbackPayload replicateBackupsCallbackPayload = (ReplicateBackupsCallbackPayload) o;
    return Objects.equals(this.prevWorkflowName, replicateBackupsCallbackPayload.prevWorkflowName) &&
        Objects.equals(this.newWorkflowName, replicateBackupsCallbackPayload.newWorkflowName) &&
        Objects.equals(this.status, replicateBackupsCallbackPayload.status) &&
        Objects.equals(this.payload, replicateBackupsCallbackPayload.payload) &&
        Objects.equals(this.context, replicateBackupsCallbackPayload.context) &&
        Objects.equals(this.lastRunCount, replicateBackupsCallbackPayload.lastRunCount) &&
        Objects.equals(this.maxRunCount, replicateBackupsCallbackPayload.maxRunCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicateBackupsCallbackPayload {\n");
