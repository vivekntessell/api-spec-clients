...
@JsonPropertyOrder({
  ServiceConnectivityUpdateInProgressInfo.JSON_PROPERTY_SERVICE_PRINCIPALS,
  ServiceConnectivityUpdateInProgressInfo.JSON_PROPERTY_CLIENT_AZURE_SUBSCRIPTION_IDS
})
@JsonTypeName("ServiceConnectivityUpdateInProgressInfo")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class ServiceConnectivityUpdateInProgressInfo {
  ...
  public ServiceConnectivityUpdateInProgressInfo servicePrincipals(Set<String> servicePrincipals) {
    
    this.servicePrincipals = servicePrincipals;
    return this;
  }

  public ServiceConnectivityUpdateInProgressInfo addServicePrincipalsItem(String servicePrincipalsItem) {
  ...
  **/
  ...
  public ServiceConnectivityUpdateInProgressInfo clientAzureSubscriptionIds(Set<UUID> clientAzureSubscriptionIds) {
    
    this.clientAzureSubscriptionIds = clientAzureSubscriptionIds;
    return this;
  }

  public ServiceConnectivityUpdateInProgressInfo addClientAzureSubscriptionIdsItem(UUID clientAzureSubscriptionIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceConnectivityUpdateInProgressInfo serviceConnectivityUpdateInProgressInfo = (ServiceConnectivityUpdateInProgressInfo) o;
    return Objects.equals(this.servicePrincipals, serviceConnectivityUpdateInProgressInfo.servicePrincipals) &&
        Objects.equals(this.clientAzureSubscriptionIds, serviceConnectivityUpdateInProgressInfo.clientAzureSubscriptionIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceConnectivityUpdateInProgressInfo {\n");
