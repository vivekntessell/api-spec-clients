...
@JsonPropertyOrder({
  BackupCallbackPayload.JSON_PROPERTY_PREV_WORKFLOW_NAME,
  BackupCallbackPayload.JSON_PROPERTY_NEW_WORKFLOW_NAME,
  BackupCallbackPayload.JSON_PROPERTY_STATUS,
  BackupCallbackPayload.JSON_PROPERTY_PAYLOAD,
  BackupCallbackPayload.JSON_PROPERTY_CONTEXT,
  BackupCallbackPayload.JSON_PROPERTY_LAST_RUN_COUNT,
  BackupCallbackPayload.JSON_PROPERTY_MAX_RUN_COUNT
})
@JsonTypeName("BackupCallbackPayload")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class BackupCallbackPayload {
  ...
  public BackupCallbackPayload prevWorkflowName(String prevWorkflowName) {
  ...
  **/
  ...
  public BackupCallbackPayload newWorkflowName(String newWorkflowName) {
  ...
  **/
  ...
  public BackupCallbackPayload status(ArgoWorkflowStatus status) {
  ...
  **/
  ...
  public BackupCallbackPayload payload(Map<String, Object> payload) {
    
    this.payload = payload;
    return this;
  }

  public BackupCallbackPayload putPayloadItem(String key, Object payloadItem) {
  ...
  **/
  ...
  public BackupCallbackPayload context(Object context) {
  ...
  **/
  ...
  public BackupCallbackPayload lastRunCount(Integer lastRunCount) {
  ...
  **/
  ...
  public BackupCallbackPayload maxRunCount(Integer maxRunCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BackupCallbackPayload backupCallbackPayload = (BackupCallbackPayload) o;
    return Objects.equals(this.prevWorkflowName, backupCallbackPayload.prevWorkflowName) &&
        Objects.equals(this.newWorkflowName, backupCallbackPayload.newWorkflowName) &&
        Objects.equals(this.status, backupCallbackPayload.status) &&
        Objects.equals(this.payload, backupCallbackPayload.payload) &&
        Objects.equals(this.context, backupCallbackPayload.context) &&
        Objects.equals(this.lastRunCount, backupCallbackPayload.lastRunCount) &&
        Objects.equals(this.maxRunCount, backupCallbackPayload.maxRunCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackupCallbackPayload {\n");
