...
@JsonPropertyOrder({
  NativeBackupCallbackPayload.JSON_PROPERTY_PREV_WORKFLOW_NAME,
  NativeBackupCallbackPayload.JSON_PROPERTY_NEW_WORKFLOW_NAME,
  NativeBackupCallbackPayload.JSON_PROPERTY_STATUS,
  NativeBackupCallbackPayload.JSON_PROPERTY_PAYLOAD,
  NativeBackupCallbackPayload.JSON_PROPERTY_CONTEXT,
  NativeBackupCallbackPayload.JSON_PROPERTY_LAST_RUN_COUNT,
  NativeBackupCallbackPayload.JSON_PROPERTY_MAX_RUN_COUNT
})
@JsonTypeName("NativeBackupCallbackPayload")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class NativeBackupCallbackPayload {
  ...
  public NativeBackupCallbackPayload prevWorkflowName(String prevWorkflowName) {
  ...
  **/
  ...
  public NativeBackupCallbackPayload newWorkflowName(String newWorkflowName) {
  ...
  **/
  ...
  public NativeBackupCallbackPayload status(ArgoWorkflowStatus status) {
  ...
  **/
  ...
  public NativeBackupCallbackPayload payload(Map<String, Object> payload) {
    
    this.payload = payload;
    return this;
  }

  public NativeBackupCallbackPayload putPayloadItem(String key, Object payloadItem) {
  ...
  **/
  ...
  public NativeBackupCallbackPayload context(Object context) {
  ...
  **/
  ...
  public NativeBackupCallbackPayload lastRunCount(Integer lastRunCount) {
  ...
  **/
  ...
  public NativeBackupCallbackPayload maxRunCount(Integer maxRunCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NativeBackupCallbackPayload nativeBackupCallbackPayload = (NativeBackupCallbackPayload) o;
    return Objects.equals(this.prevWorkflowName, nativeBackupCallbackPayload.prevWorkflowName) &&
        Objects.equals(this.newWorkflowName, nativeBackupCallbackPayload.newWorkflowName) &&
        Objects.equals(this.status, nativeBackupCallbackPayload.status) &&
        Objects.equals(this.payload, nativeBackupCallbackPayload.payload) &&
        Objects.equals(this.context, nativeBackupCallbackPayload.context) &&
        Objects.equals(this.lastRunCount, nativeBackupCallbackPayload.lastRunCount) &&
        Objects.equals(this.maxRunCount, nativeBackupCallbackPayload.maxRunCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class NativeBackupCallbackPayload {\n");
