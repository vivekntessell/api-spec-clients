...
@JsonPropertyOrder({
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_PREV_WORKFLOW_NAME,
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_NEW_WORKFLOW_NAME,
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_STATUS,
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_PAYLOAD,
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_CONTEXT,
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_LAST_RUN_COUNT,
  DeleteBackupsLogsCallbackPayload.JSON_PROPERTY_MAX_RUN_COUNT
})
@JsonTypeName("DeleteBackupsLogsCallbackPayload")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class DeleteBackupsLogsCallbackPayload {
  ...
  public DeleteBackupsLogsCallbackPayload prevWorkflowName(String prevWorkflowName) {
  ...
  **/
  ...
  public DeleteBackupsLogsCallbackPayload newWorkflowName(String newWorkflowName) {
  ...
  **/
  ...
  public DeleteBackupsLogsCallbackPayload status(ArgoWorkflowStatus status) {
  ...
  **/
  ...
  public DeleteBackupsLogsCallbackPayload payload(Map<String, Object> payload) {
    
    this.payload = payload;
    return this;
  }

  public DeleteBackupsLogsCallbackPayload putPayloadItem(String key, Object payloadItem) {
  ...
  **/
  ...
  public DeleteBackupsLogsCallbackPayload context(Object context) {
  ...
  **/
  ...
  public DeleteBackupsLogsCallbackPayload lastRunCount(Integer lastRunCount) {
  ...
  **/
  ...
  public DeleteBackupsLogsCallbackPayload maxRunCount(Integer maxRunCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteBackupsLogsCallbackPayload deleteBackupsLogsCallbackPayload = (DeleteBackupsLogsCallbackPayload) o;
    return Objects.equals(this.prevWorkflowName, deleteBackupsLogsCallbackPayload.prevWorkflowName) &&
        Objects.equals(this.newWorkflowName, deleteBackupsLogsCallbackPayload.newWorkflowName) &&
        Objects.equals(this.status, deleteBackupsLogsCallbackPayload.status) &&
        Objects.equals(this.payload, deleteBackupsLogsCallbackPayload.payload) &&
        Objects.equals(this.context, deleteBackupsLogsCallbackPayload.context) &&
        Objects.equals(this.lastRunCount, deleteBackupsLogsCallbackPayload.lastRunCount) &&
        Objects.equals(this.maxRunCount, deleteBackupsLogsCallbackPayload.maxRunCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteBackupsLogsCallbackPayload {\n");
