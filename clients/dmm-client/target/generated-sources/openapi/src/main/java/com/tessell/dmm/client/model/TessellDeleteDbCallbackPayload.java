 ...
 */
@JsonPropertyOrder({
  TessellDeleteDbCallbackPayload.JSON_PROPERTY_RETAIN_AVAILABILITY_MACHINE
})
@JsonTypeName("TessellDeleteDbCallbackPayload")
@lombok.Builder
@lombok.NoArgsConstructor
@lombok.AllArgsConstructor
@javax.annotation.Generated(value = "com.tessell.codegen.TessellJavaGenerator", date = "2024-05-02T15:56:39.699111+05:30[Asia/Kolkata]")
@JsonIgnoreProperties(ignoreUnknown = true)
public class TessellDeleteDbCallbackPayload {
  ...
  public TessellDeleteDbCallbackPayload retainAvailabilityMachine(Boolean retainAvailabilityMachine) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellDeleteDbCallbackPayload tessellDeleteDbCallbackPayload = (TessellDeleteDbCallbackPayload) o;
    return Objects.equals(this.retainAvailabilityMachine, tessellDeleteDbCallbackPayload.retainAvailabilityMachine);
  }
  ...
  public String toString() {
    ...
    sb.append("class TessellDeleteDbCallbackPayload {\n");
