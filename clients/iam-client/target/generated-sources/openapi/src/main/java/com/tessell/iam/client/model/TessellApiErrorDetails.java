...
@JsonPropertyOrder({
  TessellApiErrorDetails.JSON_PROPERTY_RESOLUTION
})
...
public class TessellApiErrorDetails {
  public static final String JSON_PROPERTY_RESOLUTION = "resolution";
  private String resolution;


  public TessellApiErrorDetails resolution(String resolution) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellApiErrorDetails apiErrorDetails = (TessellApiErrorDetails) o;
  ...
  public String toString() {
    ...
    sb.append("class TessellApiErrorDetails {\n");
