...
import com.tessell.iam.client.model.TessellApiErrorDetails;
import com.tessell.iam.client.model.TessellTessellErrorCode;
...
@JsonPropertyOrder({
  TessellApiErrorOps.JSON_PROPERTY_ERROR_CODE,
  TessellApiErrorOps.JSON_PROPERTY_MESSAGE,
  TessellApiErrorOps.JSON_PROPERTY_DETAILS,
  TessellApiErrorOps.JSON_PROPERTY_SERVICE_EXCEPTION,
  TessellApiErrorOps.JSON_PROPERTY_CONTEXT_ID,
  TessellApiErrorOps.JSON_PROPERTY_SESSION_ID
})
...
public class TessellApiErrorOps {
  public static final String JSON_PROPERTY_ERROR_CODE = "errorCode";
  private TessellTessellErrorCode errorCode;

  public static final String JSON_PROPERTY_MESSAGE = "message";
  private String message;

  public static final String JSON_PROPERTY_DETAILS = "details";
  private TessellApiErrorDetails details;

  public static final String JSON_PROPERTY_SERVICE_EXCEPTION = "serviceException";
  private TessellApiError serviceException;
  ...
  public TessellApiErrorOps errorCode(TessellTessellErrorCode errorCode) {
  ...
  **/
  ...
  public TessellTessellErrorCode getErrorCode() {
    return errorCode;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR_CODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setErrorCode(TessellTessellErrorCode errorCode) {
    this.errorCode = errorCode;
  }


  public TessellApiErrorOps message(String message) {
  ...
  **/
  ...
  public TessellApiErrorOps details(TessellApiErrorDetails details) {
  ...
  **/
  ...
  public TessellApiErrorDetails getDetails() {
    return details;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetails(TessellApiErrorDetails details) {
    this.details = details;
  }


  public TessellApiErrorOps serviceException(TessellApiError serviceException) {
  ...
  **/
  ...
  public TessellApiError getServiceException() {
    return serviceException;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SERVICE_EXCEPTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setServiceException(TessellApiError serviceException) {
    this.serviceException = serviceException;
  }


  public TessellApiErrorOps contextId(String contextId) {
  ...
  **/
  ...
  public TessellApiErrorOps sessionId(String sessionId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellApiErrorOps apiErrorOps = (TessellApiErrorOps) o;
  ...
  public String toString() {
    ...
    sb.append("class TessellApiErrorOps {\n");
