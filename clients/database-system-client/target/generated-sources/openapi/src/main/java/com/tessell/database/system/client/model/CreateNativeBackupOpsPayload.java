 ...
 */
@JsonPropertyOrder({
  CreateNativeBackupOpsPayload.JSON_PROPERTY_NATIVE_BACKUP_PAYLOAD,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_BACKUP_VALIDATION_INFO,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_SNAPSHOT_ID,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_PITR,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_NAME,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_DESCRIPTION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_SUBSCRIPTION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_EDITION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_ENGINE_TYPE,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_TOPOLOGY,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_NUM_OF_INSTANCES,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_SOFTWARE_IMAGE,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_SOFTWARE_IMAGE_VERSION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_AUTO_MINOR_VERSION_UPDATE,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_ENABLE_DELETION_PROTECTION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_ENABLE_STOP_PROTECTION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_ENABLE_PERF_INSIGHTS,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_INFRASTRUCTURE,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_SERVICE_CONNECTIVITY,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_CREDS,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_MAINTENANCE_WINDOW,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_DELETION_CONFIG,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_SNAPSHOT_CONFIGURATION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_ENGINE_CONFIGURATION,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_DATABASES,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_INTEGRATIONS_CONFIG,
  CreateNativeBackupOpsPayload.JSON_PROPERTY_TAGS
})
@JsonTypeName("CreateNativeBackupOpsPayload")
...
public class CreateNativeBackupOpsPayload {
  ...
  public CreateNativeBackupOpsPayload nativeBackupPayload(NativeBackupOpsPayload nativeBackupPayload) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload backupValidationInfo(CloneBackupValidationResponse backupValidationInfo) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload snapshotId(UUID snapshotId) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload pitr(String pitr) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload name(String name) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload description(String description) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload subscription(String subscription) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload edition(String edition) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload engineType(DatabaseEngineType engineType) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload topology(TessellServiceTopology topology) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload numOfInstances(Integer numOfInstances) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload softwareImage(String softwareImage) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload softwareImageVersion(String softwareImageVersion) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload autoMinorVersionUpdate(Boolean autoMinorVersionUpdate) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload enableDeletionProtection(Boolean enableDeletionProtection) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload enableStopProtection(Boolean enableStopProtection) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload enablePerfInsights(Boolean enablePerfInsights) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload infrastructure(TessellServiceInfrastructurePayload1 infrastructure) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload serviceConnectivity(TessellServiceConnectivityInfoPayload serviceConnectivity) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload creds(TessellServiceCredsPayload creds) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload maintenanceWindow(TessellServiceMaintenanceWindow maintenanceWindow) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload deletionConfig(TessellServiceDeletionConfig deletionConfig) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload snapshotConfiguration(SnapshotConfigurationPayload snapshotConfiguration) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload engineConfiguration(TessellServiceEngineConfigurationPayload1 engineConfiguration) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload databases(List<CreateDatabasePayload1> databases) {
    
    this.databases = databases;
    return this;
  }

  public CreateNativeBackupOpsPayload addDatabasesItem(CreateDatabasePayload1 databasesItem) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload integrationsConfig(TessellServiceIntegrationsPayload integrationsConfig) {
  ...
  **/
  ...
  public CreateNativeBackupOpsPayload tags(List<TessellTag> tags) {
    
    this.tags = tags;
    return this;
  }

  public CreateNativeBackupOpsPayload addTagsItem(TessellTag tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateNativeBackupOpsPayload createNativeBackupOpsPayload = (CreateNativeBackupOpsPayload) o;
    return Objects.equals(this.nativeBackupPayload, createNativeBackupOpsPayload.nativeBackupPayload) &&
        Objects.equals(this.backupValidationInfo, createNativeBackupOpsPayload.backupValidationInfo) &&
        Objects.equals(this.snapshotId, createNativeBackupOpsPayload.snapshotId) &&
        Objects.equals(this.pitr, createNativeBackupOpsPayload.pitr) &&
        Objects.equals(this.name, createNativeBackupOpsPayload.name) &&
        Objects.equals(this.description, createNativeBackupOpsPayload.description) &&
        Objects.equals(this.subscription, createNativeBackupOpsPayload.subscription) &&
        Objects.equals(this.edition, createNativeBackupOpsPayload.edition) &&
        Objects.equals(this.engineType, createNativeBackupOpsPayload.engineType) &&
        Objects.equals(this.topology, createNativeBackupOpsPayload.topology) &&
        Objects.equals(this.numOfInstances, createNativeBackupOpsPayload.numOfInstances) &&
        Objects.equals(this.softwareImage, createNativeBackupOpsPayload.softwareImage) &&
        Objects.equals(this.softwareImageVersion, createNativeBackupOpsPayload.softwareImageVersion) &&
        Objects.equals(this.autoMinorVersionUpdate, createNativeBackupOpsPayload.autoMinorVersionUpdate) &&
        Objects.equals(this.enableDeletionProtection, createNativeBackupOpsPayload.enableDeletionProtection) &&
        Objects.equals(this.enableStopProtection, createNativeBackupOpsPayload.enableStopProtection) &&
        Objects.equals(this.enablePerfInsights, createNativeBackupOpsPayload.enablePerfInsights) &&
        Objects.equals(this.infrastructure, createNativeBackupOpsPayload.infrastructure) &&
        Objects.equals(this.serviceConnectivity, createNativeBackupOpsPayload.serviceConnectivity) &&
        Objects.equals(this.creds, createNativeBackupOpsPayload.creds) &&
        Objects.equals(this.maintenanceWindow, createNativeBackupOpsPayload.maintenanceWindow) &&
        Objects.equals(this.deletionConfig, createNativeBackupOpsPayload.deletionConfig) &&
        Objects.equals(this.snapshotConfiguration, createNativeBackupOpsPayload.snapshotConfiguration) &&
        Objects.equals(this.engineConfiguration, createNativeBackupOpsPayload.engineConfiguration) &&
        Objects.equals(this.databases, createNativeBackupOpsPayload.databases) &&
        Objects.equals(this.integrationsConfig, createNativeBackupOpsPayload.integrationsConfig) &&
        Objects.equals(this.tags, createNativeBackupOpsPayload.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nativeBackupPayload, backupValidationInfo, snapshotId, pitr, name, description, subscription, edition, engineType, topology, numOfInstances, softwareImage, softwareImageVersion, autoMinorVersionUpdate, enableDeletionProtection, enableStopProtection, enablePerfInsights, infrastructure, serviceConnectivity, creds, maintenanceWindow, deletionConfig, snapshotConfiguration, engineConfiguration, databases, integrationsConfig, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateNativeBackupOpsPayload {\n");
