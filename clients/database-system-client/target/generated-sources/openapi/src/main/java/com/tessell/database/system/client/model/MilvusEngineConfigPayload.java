 ...
 */
@JsonPropertyOrder({
  MilvusEngineConfigPayload.JSON_PROPERTY_PARAMETER_PROFILE_ID
})
@JsonTypeName("MilvusEngineConfigPayload")
...
public class MilvusEngineConfigPayload {
  public static final String JSON_PROPERTY_PARAMETER_PROFILE_ID = "parameterProfileId";
  private UUID parameterProfileId;


  public MilvusEngineConfigPayload parameterProfileId(UUID parameterProfileId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MilvusEngineConfigPayload milvusEngineConfigPayload = (MilvusEngineConfigPayload) o;
    return Objects.equals(this.parameterProfileId, milvusEngineConfigPayload.parameterProfileId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MilvusEngineConfigPayload {\n");
