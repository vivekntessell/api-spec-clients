 ...
 */
@ApiModel(description = "If the DB Service is to be deleted, this config would be honoured if no preference is provided during deleting the service")
@JsonPropertyOrder({
  TessellServiceDeletionConfig.JSON_PROPERTY_RETAIN_AVAILABILITY_MACHINE
})
@JsonTypeName("TessellServiceDeletionConfig")
...
public class TessellServiceDeletionConfig {
  ...
  public TessellServiceDeletionConfig retainAvailabilityMachine(Boolean retainAvailabilityMachine) {
  ...
  **/
  ...
  @ApiModelProperty(value = "If specified as true, the associated Availability Machine (snapshots, sanitized-snapshots, logs) would be retained")
  ...
  public boolean equals(Object o) {
    ...
    TessellServiceDeletionConfig tessellServiceDeletionConfig = (TessellServiceDeletionConfig) o;
    return Objects.equals(this.retainAvailabilityMachine, tessellServiceDeletionConfig.retainAvailabilityMachine);
  }
  ...
  public String toString() {
    ...
    sb.append("class TessellServiceDeletionConfig {\n");
