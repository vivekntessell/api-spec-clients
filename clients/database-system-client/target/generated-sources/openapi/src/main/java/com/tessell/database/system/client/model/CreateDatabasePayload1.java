 ...
 */
@JsonPropertyOrder({
  CreateDatabasePayload1.JSON_PROPERTY_DATABASE_NAME,
  CreateDatabasePayload1.JSON_PROPERTY_SOURCE_DATABASE_ID,
  CreateDatabasePayload1.JSON_PROPERTY_DATABASE_CONFIGURATION,
  CreateDatabasePayload1.JSON_PROPERTY_COLLECTION_CONFIG
})
@JsonTypeName("CreateDatabasePayload_1")
...
public class CreateDatabasePayload1 {
  ...
  private DbCollectionCreatePayload1 collectionConfig;


  public CreateDatabasePayload1 databaseName(String databaseName) {
  ...
  **/
  ...
  public CreateDatabasePayload1 sourceDatabaseId(UUID sourceDatabaseId) {
  ...
  **/
  ...
  public CreateDatabasePayload1 databaseConfiguration(CreateDatabasePayloadDatabaseConfiguration databaseConfiguration) {
  ...
  **/
  ...
  public CreateDatabasePayload1 collectionConfig(DbCollectionCreatePayload1 collectionConfig) {
  ...
  **/
  ...
  public DbCollectionCreatePayload1 getCollectionConfig() {
    return collectionConfig;
  }
  ...
  @JsonProperty(JSON_PROPERTY_COLLECTION_CONFIG)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCollectionConfig(DbCollectionCreatePayload1 collectionConfig) {
    this.collectionConfig = collectionConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateDatabasePayload1 createDatabasePayload1 = (CreateDatabasePayload1) o;
    return Objects.equals(this.databaseName, createDatabasePayload1.databaseName) &&
        Objects.equals(this.sourceDatabaseId, createDatabasePayload1.sourceDatabaseId) &&
        Objects.equals(this.databaseConfiguration, createDatabasePayload1.databaseConfiguration) &&
        Objects.equals(this.collectionConfig, createDatabasePayload1.collectionConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDatabasePayload1 {\n");
