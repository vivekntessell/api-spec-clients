 ...
 */
@JsonPropertyOrder({
  TessellServiceMilvusEngineConfig.JSON_PROPERTY_PARAMETER_PROFILE_ID
})
@JsonTypeName("TessellServiceMilvusEngineConfig")
...
public class TessellServiceMilvusEngineConfig {
  public static final String JSON_PROPERTY_PARAMETER_PROFILE_ID = "parameterProfileId";
  private UUID parameterProfileId;


  public TessellServiceMilvusEngineConfig parameterProfileId(UUID parameterProfileId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellServiceMilvusEngineConfig tessellServiceMilvusEngineConfig = (TessellServiceMilvusEngineConfig) o;
    return Objects.equals(this.parameterProfileId, tessellServiceMilvusEngineConfig.parameterProfileId);
  }
  ...
  public String toString() {
    ...
    sb.append("class TessellServiceMilvusEngineConfig {\n");
