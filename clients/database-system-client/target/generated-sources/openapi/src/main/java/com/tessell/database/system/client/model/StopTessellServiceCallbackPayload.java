...
@JsonPropertyOrder({
  StopTessellServiceCallbackPayload.JSON_PROPERTY_PREV_WORKFLOW_NAME,
  StopTessellServiceCallbackPayload.JSON_PROPERTY_NEW_WORKFLOW_NAME,
  StopTessellServiceCallbackPayload.JSON_PROPERTY_STATUS,
  StopTessellServiceCallbackPayload.JSON_PROPERTY_PAYLOAD,
  StopTessellServiceCallbackPayload.JSON_PROPERTY_CONTEXT,
  StopTessellServiceCallbackPayload.JSON_PROPERTY_LAST_RUN_COUNT,
  StopTessellServiceCallbackPayload.JSON_PROPERTY_MAX_RUN_COUNT
})
@JsonTypeName("StopTessellServiceCallbackPayload")
...
public class StopTessellServiceCallbackPayload {
  ...
  public StopTessellServiceCallbackPayload prevWorkflowName(String prevWorkflowName) {
  ...
  **/
  ...
  public StopTessellServiceCallbackPayload newWorkflowName(String newWorkflowName) {
  ...
  **/
  ...
  public StopTessellServiceCallbackPayload status(ArgoWorkflowStatus status) {
  ...
  **/
  ...
  public StopTessellServiceCallbackPayload payload(Map<String, Object> payload) {
    
    this.payload = payload;
    return this;
  }

  public StopTessellServiceCallbackPayload putPayloadItem(String key, Object payloadItem) {
  ...
  **/
  ...
  public StopTessellServiceCallbackPayload context(Object context) {
  ...
  **/
  ...
  public StopTessellServiceCallbackPayload lastRunCount(Integer lastRunCount) {
  ...
  **/
  ...
  public StopTessellServiceCallbackPayload maxRunCount(Integer maxRunCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StopTessellServiceCallbackPayload stopTessellServiceCallbackPayload = (StopTessellServiceCallbackPayload) o;
    return Objects.equals(this.prevWorkflowName, stopTessellServiceCallbackPayload.prevWorkflowName) &&
        Objects.equals(this.newWorkflowName, stopTessellServiceCallbackPayload.newWorkflowName) &&
        Objects.equals(this.status, stopTessellServiceCallbackPayload.status) &&
        Objects.equals(this.payload, stopTessellServiceCallbackPayload.payload) &&
        Objects.equals(this.context, stopTessellServiceCallbackPayload.context) &&
        Objects.equals(this.lastRunCount, stopTessellServiceCallbackPayload.lastRunCount) &&
        Objects.equals(this.maxRunCount, stopTessellServiceCallbackPayload.maxRunCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopTessellServiceCallbackPayload {\n");
