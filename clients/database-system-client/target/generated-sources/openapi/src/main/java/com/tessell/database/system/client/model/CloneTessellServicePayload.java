...
import com.tessell.database.system.client.model.CloneTessellServicePayloadAllOf;
...
import com.tessell.database.system.client.model.ProvisionTessellServicePayload1;
 ...
 */
@JsonPropertyOrder({
  CloneTessellServicePayload.JSON_PROPERTY_SNAPSHOT_ID,
  CloneTessellServicePayload.JSON_PROPERTY_PITR,
  CloneTessellServicePayload.JSON_PROPERTY_NAME,
  CloneTessellServicePayload.JSON_PROPERTY_DESCRIPTION,
  CloneTessellServicePayload.JSON_PROPERTY_SUBSCRIPTION,
  CloneTessellServicePayload.JSON_PROPERTY_EDITION,
  CloneTessellServicePayload.JSON_PROPERTY_ENGINE_TYPE,
  CloneTessellServicePayload.JSON_PROPERTY_TOPOLOGY,
  CloneTessellServicePayload.JSON_PROPERTY_NUM_OF_INSTANCES,
  CloneTessellServicePayload.JSON_PROPERTY_SOFTWARE_IMAGE,
  CloneTessellServicePayload.JSON_PROPERTY_SOFTWARE_IMAGE_VERSION,
  CloneTessellServicePayload.JSON_PROPERTY_AUTO_MINOR_VERSION_UPDATE,
  CloneTessellServicePayload.JSON_PROPERTY_ENABLE_DELETION_PROTECTION,
  CloneTessellServicePayload.JSON_PROPERTY_ENABLE_STOP_PROTECTION,
  CloneTessellServicePayload.JSON_PROPERTY_ENABLE_PERF_INSIGHTS,
  CloneTessellServicePayload.JSON_PROPERTY_INFRASTRUCTURE,
  CloneTessellServicePayload.JSON_PROPERTY_SERVICE_CONNECTIVITY,
  CloneTessellServicePayload.JSON_PROPERTY_CREDS,
  CloneTessellServicePayload.JSON_PROPERTY_MAINTENANCE_WINDOW,
  CloneTessellServicePayload.JSON_PROPERTY_DELETION_CONFIG,
  CloneTessellServicePayload.JSON_PROPERTY_SNAPSHOT_CONFIGURATION,
  CloneTessellServicePayload.JSON_PROPERTY_ENGINE_CONFIGURATION,
  CloneTessellServicePayload.JSON_PROPERTY_DATABASES,
  CloneTessellServicePayload.JSON_PROPERTY_INTEGRATIONS_CONFIG,
  CloneTessellServicePayload.JSON_PROPERTY_TAGS
})
@JsonTypeName("CloneTessellServicePayload")
...
public class CloneTessellServicePayload {
  ...
  public CloneTessellServicePayload snapshotId(UUID snapshotId) {
  ...
  **/
  ...
  public CloneTessellServicePayload pitr(String pitr) {
  ...
  **/
  ...
  public CloneTessellServicePayload name(String name) {
  ...
  **/
  ...
  public CloneTessellServicePayload description(String description) {
  ...
  **/
  ...
  public CloneTessellServicePayload subscription(String subscription) {
  ...
  **/
  ...
  public CloneTessellServicePayload edition(String edition) {
  ...
  **/
  ...
  public CloneTessellServicePayload engineType(DatabaseEngineType engineType) {
  ...
  **/
  ...
  public CloneTessellServicePayload topology(TessellServiceTopology topology) {
  ...
  **/
  ...
  public CloneTessellServicePayload numOfInstances(Integer numOfInstances) {
  ...
  **/
  ...
  public CloneTessellServicePayload softwareImage(String softwareImage) {
  ...
  **/
  ...
  public CloneTessellServicePayload softwareImageVersion(String softwareImageVersion) {
  ...
  **/
  ...
  public CloneTessellServicePayload autoMinorVersionUpdate(Boolean autoMinorVersionUpdate) {
  ...
  **/
  ...
  public CloneTessellServicePayload enableDeletionProtection(Boolean enableDeletionProtection) {
  ...
  **/
  ...
  public CloneTessellServicePayload enableStopProtection(Boolean enableStopProtection) {
  ...
  **/
  ...
  public CloneTessellServicePayload enablePerfInsights(Boolean enablePerfInsights) {
  ...
  **/
  ...
  public CloneTessellServicePayload infrastructure(TessellServiceInfrastructurePayload1 infrastructure) {
  ...
  **/
  ...
  public CloneTessellServicePayload serviceConnectivity(TessellServiceConnectivityInfoPayload serviceConnectivity) {
  ...
  **/
  ...
  public CloneTessellServicePayload creds(TessellServiceCredsPayload creds) {
  ...
  **/
  ...
  public CloneTessellServicePayload maintenanceWindow(TessellServiceMaintenanceWindow maintenanceWindow) {
  ...
  **/
  ...
  public CloneTessellServicePayload deletionConfig(TessellServiceDeletionConfig deletionConfig) {
  ...
  **/
  ...
  public CloneTessellServicePayload snapshotConfiguration(SnapshotConfigurationPayload snapshotConfiguration) {
  ...
  **/
  ...
  public CloneTessellServicePayload engineConfiguration(TessellServiceEngineConfigurationPayload1 engineConfiguration) {
  ...
  **/
  ...
  public CloneTessellServicePayload databases(List<CreateDatabasePayload1> databases) {
    
    this.databases = databases;
    return this;
  }

  public CloneTessellServicePayload addDatabasesItem(CreateDatabasePayload1 databasesItem) {
  ...
  **/
  ...
  public CloneTessellServicePayload integrationsConfig(TessellServiceIntegrationsPayload integrationsConfig) {
  ...
  **/
  ...
  public CloneTessellServicePayload tags(List<TessellTag> tags) {
    
    this.tags = tags;
    return this;
  }

  public CloneTessellServicePayload addTagsItem(TessellTag tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CloneTessellServicePayload cloneTessellServicePayload = (CloneTessellServicePayload) o;
    return Objects.equals(this.snapshotId, cloneTessellServicePayload.snapshotId) &&
        Objects.equals(this.pitr, cloneTessellServicePayload.pitr) &&
        Objects.equals(this.name, cloneTessellServicePayload.name) &&
        Objects.equals(this.description, cloneTessellServicePayload.description) &&
        Objects.equals(this.subscription, cloneTessellServicePayload.subscription) &&
        Objects.equals(this.edition, cloneTessellServicePayload.edition) &&
        Objects.equals(this.engineType, cloneTessellServicePayload.engineType) &&
        Objects.equals(this.topology, cloneTessellServicePayload.topology) &&
        Objects.equals(this.numOfInstances, cloneTessellServicePayload.numOfInstances) &&
        Objects.equals(this.softwareImage, cloneTessellServicePayload.softwareImage) &&
        Objects.equals(this.softwareImageVersion, cloneTessellServicePayload.softwareImageVersion) &&
        Objects.equals(this.autoMinorVersionUpdate, cloneTessellServicePayload.autoMinorVersionUpdate) &&
        Objects.equals(this.enableDeletionProtection, cloneTessellServicePayload.enableDeletionProtection) &&
        Objects.equals(this.enableStopProtection, cloneTessellServicePayload.enableStopProtection) &&
        Objects.equals(this.enablePerfInsights, cloneTessellServicePayload.enablePerfInsights) &&
        Objects.equals(this.infrastructure, cloneTessellServicePayload.infrastructure) &&
        Objects.equals(this.serviceConnectivity, cloneTessellServicePayload.serviceConnectivity) &&
        Objects.equals(this.creds, cloneTessellServicePayload.creds) &&
        Objects.equals(this.maintenanceWindow, cloneTessellServicePayload.maintenanceWindow) &&
        Objects.equals(this.deletionConfig, cloneTessellServicePayload.deletionConfig) &&
        Objects.equals(this.snapshotConfiguration, cloneTessellServicePayload.snapshotConfiguration) &&
        Objects.equals(this.engineConfiguration, cloneTessellServicePayload.engineConfiguration) &&
        Objects.equals(this.databases, cloneTessellServicePayload.databases) &&
        Objects.equals(this.integrationsConfig, cloneTessellServicePayload.integrationsConfig) &&
        Objects.equals(this.tags, cloneTessellServicePayload.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(snapshotId, pitr, name, description, subscription, edition, engineType, topology, numOfInstances, softwareImage, softwareImageVersion, autoMinorVersionUpdate, enableDeletionProtection, enableStopProtection, enablePerfInsights, infrastructure, serviceConnectivity, creds, maintenanceWindow, deletionConfig, snapshotConfiguration, engineConfiguration, databases, integrationsConfig, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CloneTessellServicePayload {\n");
