 ...
 */
@JsonPropertyOrder({
  ProvisionComputePayload1.JSON_PROPERTY_REGION,
  ProvisionComputePayload1.JSON_PROPERTY_AVAILABILITY_ZONE,
  ProvisionComputePayload1.JSON_PROPERTY_ROLE,
  ProvisionComputePayload1.JSON_PROPERTY_VPC,
  ProvisionComputePayload1.JSON_PROPERTY_COMPUTE_TYPE,
  ProvisionComputePayload1.JSON_PROPERTY_COMPUTE_ID,
  ProvisionComputePayload1.JSON_PROPERTY_TIMEZONE
})
@JsonTypeName("ProvisionComputePayload_1")
...
public class ProvisionComputePayload1 {
  ...
  public ProvisionComputePayload1 region(String region) {
  ...
  **/
  ...
  public ProvisionComputePayload1 availabilityZone(String availabilityZone) {
  ...
  **/
  ...
  public ProvisionComputePayload1 role(TessellServiceInstanceRole role) {
  ...
  **/
  ...
  public ProvisionComputePayload1 vpc(String vpc) {
  ...
  **/
  ...
  public ProvisionComputePayload1 computeType(String computeType) {
  ...
  **/
  ...
  public ProvisionComputePayload1 computeId(UUID computeId) {
  ...
  **/
  ...
  public ProvisionComputePayload1 timezone(String timezone) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProvisionComputePayload1 provisionComputePayload1 = (ProvisionComputePayload1) o;
    return Objects.equals(this.region, provisionComputePayload1.region) &&
        Objects.equals(this.availabilityZone, provisionComputePayload1.availabilityZone) &&
        Objects.equals(this.role, provisionComputePayload1.role) &&
        Objects.equals(this.vpc, provisionComputePayload1.vpc) &&
        Objects.equals(this.computeType, provisionComputePayload1.computeType) &&
        Objects.equals(this.computeId, provisionComputePayload1.computeId) &&
        Objects.equals(this.timezone, provisionComputePayload1.timezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvisionComputePayload1 {\n");
