 ...
 */
@JsonPropertyOrder({
  ApacheKafkaEngineConfigPayload.JSON_PROPERTY_PARAMETER_PROFILE_ID
})
@JsonTypeName("ApacheKafkaEngineConfigPayload")
...
public class ApacheKafkaEngineConfigPayload {
  public static final String JSON_PROPERTY_PARAMETER_PROFILE_ID = "parameterProfileId";
  private UUID parameterProfileId;


  public ApacheKafkaEngineConfigPayload parameterProfileId(UUID parameterProfileId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApacheKafkaEngineConfigPayload apacheKafkaEngineConfigPayload = (ApacheKafkaEngineConfigPayload) o;
    return Objects.equals(this.parameterProfileId, apacheKafkaEngineConfigPayload.parameterProfileId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApacheKafkaEngineConfigPayload {\n");
