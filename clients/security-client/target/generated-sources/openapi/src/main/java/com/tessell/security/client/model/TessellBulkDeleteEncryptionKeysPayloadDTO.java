 ...
 */
@JsonPropertyOrder({
  TessellBulkDeleteEncryptionKeysPayloadDTO.JSON_PROPERTY_TENANT_ID,
  TessellBulkDeleteEncryptionKeysPayloadDTO.JSON_PROPERTY_SUBSCRIPTION_ID,
  TessellBulkDeleteEncryptionKeysPayloadDTO.JSON_PROPERTY_SKIP_DELETION,
  TessellBulkDeleteEncryptionKeysPayloadDTO.JSON_PROPERTY_SCHEDULE_DELETION_AFTER_DAYS
})
@JsonTypeName("BulkDeleteEncryptionKeysPayload")
@lombok.Builder
...
public class TessellBulkDeleteEncryptionKeysPayloadDTO {
  ...
  public TessellBulkDeleteEncryptionKeysPayloadDTO tenantId(UUID tenantId) {
  ...
  **/
  ...
  public TessellBulkDeleteEncryptionKeysPayloadDTO subscriptionId(UUID subscriptionId) {
  ...
  **/
  ...
  public TessellBulkDeleteEncryptionKeysPayloadDTO skipDeletion(List<TessellSkipDeletionInfoDTO> skipDeletion) {
    
    this.skipDeletion = skipDeletion;
    return this;
  }

  public TessellBulkDeleteEncryptionKeysPayloadDTO addSkipDeletionItem(TessellSkipDeletionInfoDTO skipDeletionItem) {
  ...
  **/
  ...
  public TessellBulkDeleteEncryptionKeysPayloadDTO scheduleDeletionAfterDays(Integer scheduleDeletionAfterDays) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellBulkDeleteEncryptionKeysPayloadDTO bulkDeleteEncryptionKeysPayload = (TessellBulkDeleteEncryptionKeysPayloadDTO) o;
    return Objects.equals(this.tenantId, bulkDeleteEncryptionKeysPayload.tenantId) &&
        Objects.equals(this.subscriptionId, bulkDeleteEncryptionKeysPayload.subscriptionId) &&
        Objects.equals(this.skipDeletion, bulkDeleteEncryptionKeysPayload.skipDeletion) &&
        Objects.equals(this.scheduleDeletionAfterDays, bulkDeleteEncryptionKeysPayload.scheduleDeletionAfterDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class TessellBulkDeleteEncryptionKeysPayloadDTO {\n");
