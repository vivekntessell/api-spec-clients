 ...
 */
@JsonPropertyOrder({
  TessellBulkDeleteVpcsPayloadDTO.JSON_PROPERTY_TENANT_ID,
  TessellBulkDeleteVpcsPayloadDTO.JSON_PROPERTY_SUBSCRIPTION_ID,
  TessellBulkDeleteVpcsPayloadDTO.JSON_PROPERTY_SKIP_DELETION,
  TessellBulkDeleteVpcsPayloadDTO.JSON_PROPERTY_SCHEDULE_DELETION_AFTER_DAYS
})
@JsonTypeName("BulkDeleteVpcsPayload")
@lombok.Builder
...
public class TessellBulkDeleteVpcsPayloadDTO {
  ...
  public TessellBulkDeleteVpcsPayloadDTO tenantId(UUID tenantId) {
  ...
  **/
  ...
  public TessellBulkDeleteVpcsPayloadDTO subscriptionId(UUID subscriptionId) {
  ...
  **/
  ...
  public TessellBulkDeleteVpcsPayloadDTO skipDeletion(List<TessellSkipDeletionInfoDTO> skipDeletion) {
    
    this.skipDeletion = skipDeletion;
    return this;
  }

  public TessellBulkDeleteVpcsPayloadDTO addSkipDeletionItem(TessellSkipDeletionInfoDTO skipDeletionItem) {
  ...
  **/
  ...
  public TessellBulkDeleteVpcsPayloadDTO scheduleDeletionAfterDays(Integer scheduleDeletionAfterDays) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TessellBulkDeleteVpcsPayloadDTO bulkDeleteVpcsPayload = (TessellBulkDeleteVpcsPayloadDTO) o;
    return Objects.equals(this.tenantId, bulkDeleteVpcsPayload.tenantId) &&
        Objects.equals(this.subscriptionId, bulkDeleteVpcsPayload.subscriptionId) &&
        Objects.equals(this.skipDeletion, bulkDeleteVpcsPayload.skipDeletion) &&
        Objects.equals(this.scheduleDeletionAfterDays, bulkDeleteVpcsPayload.scheduleDeletionAfterDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class TessellBulkDeleteVpcsPayloadDTO {\n");
